...
class Slider {
    ...
    constructor(viewport, wrapper, slides, nextButton, prevButton, currentPage, totalPages) {
        ...
        this.gap = this.slidesPerPage > 1 ? Math.floor((this.viewportWidth - this.slidesPerPage * this.slideWidth) / (this.slidesPerPage - 1)) : 20
    ...
    nextPage(cycle) {
        ...
        this.currentIndex = this.nextIndex
        this.currentPage.innerHTML = this.currentIndex < this.lastIndex ? this.currentIndex + 1 : 1
...
const playersSlider = new Slider(
    ...
    document.querySelector(".players__slider>.slider__pages>.slider__current-page"),
...
const historySlider = new Slider(
    ...
    document.querySelector(".history__slider>.slider__pages>.slider__current-page"),
